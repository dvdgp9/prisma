...
$expectedByRole = [
    'user' => ['view' => true, 'comment' => true, 'checklist' => true, 'update_status' => true, 'edit' => false, 'delete' => false],
    'programador' => ['view' => true, 'comment' => true, 'checklist' => true, 'update_status' => true, 'edit' => true, 'delete' => false],
    'admin' => ['view' => true, 'comment' => true, 'checklist' => true, 'update_status' => true, 'edit' => true, 'delete' => true],
    'superadmin' => ['view' => true, 'comment' => true, 'checklist' => true, 'update_status' => true, 'edit' => true, 'delete' => true],
];
...
foreach ($expectedByRole as $role => $expected) {
    ...
    assert_same(
        ['view' => false, 'comment' => false, 'checklist' => false, 'update_status' => false, 'edit' => false, 'delete' => false],
...
$userSafeRequest = sanitize_request_for_capabilities(
    $externalRequest,
    ['view' => true, 'comment' => true, 'checklist' => true, 'update_status' => true, 'edit' => false, 'delete' => false]
);
...
assert_same(
    ...
    sanitize_request_for_capabilities(
        $externalRequest,
        ['view' => true, 'comment' => true, 'checklist' => true, 'update_status' => true, 'edit' => true, 'delete' => false]
    ),
